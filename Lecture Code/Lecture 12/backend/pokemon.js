...
router.get('/', function(req, res) {
    ...
    PokemonModel.findPokemonByUsername(username)//.returnAllPokemon()
        .then(function(dbResponse) {
            // Can add option to determine length of time cookie lasts
            // By default, will last "forever", which I think is good
            // until they clear their cookies
            res.cookie("pokemonCount", dbResponse.length)
            res.send(dbResponse);
        })
        .catch(function(error) {
